...
const s = {
  ...
  logo: { background: 'linear-gradient(135deg, #a78bfa, #6366f1)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', fontSize: '1.1rem', fontWeight: '700' },
  ...
  input: { width: '100%', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '12px', padding: '0.75rem 1rem', color: '#e2e8f0', fontSize: '0.95rem', marginBottom: '1.1rem', outline: 'none', boxSizing: 'border-box' },
  roleRow: { display: 'flex', gap: '0.75rem', marginBottom: '1.25rem' },
  roleBtn: { flex: 1, padding: '0.65rem', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '12px', color: '#64748b', cursor: 'pointer', fontSize: '0.88rem', fontWeight: '500' },
  roleActive: { background: 'rgba(99,102,241,0.15)', border: '1px solid rgba(99,102,241,0.35)', color: '#a78bfa' },
  btn: { width: '100%', background: 'linear-gradient(135deg, #6366f1, #8b5cf6)', color: '#fff', border: 'none', borderRadius: '12px', padding: '0.85rem', fontSize: '0.95rem', fontWeight: '600', cursor: 'pointer', position: 'relative', overflow: 'hidden', boxShadow: '0 8px 25px rgba(99,102,241,0.4)' },
